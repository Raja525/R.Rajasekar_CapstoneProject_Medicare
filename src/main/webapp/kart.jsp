		...
		while(rs1.next())
			...
			%>
				  ...
				  <div id="item" class="row">
						...
						<div class="col-md-6 col-sm-12" id="itemmsg">
						...
						<div class="col-md-2 col-sm-12" id="removebtn">
							<form action="removekart" method="post"><button type="submit" class="btn btn-danger" name="removekart" value="<%=rs1.getString("Id")%>">Remove</button></form>
						</div>
					</div>
				</a>
			    <%
